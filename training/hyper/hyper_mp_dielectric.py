hyper = {
    ...
    "DimeNetPP.make_crystal_model": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 64, "epochs": 300, "validation_freq": 10, "verbose": 2, "callbacks": [],
    ...
    "NMPN.make_crystal_model": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 16, "epochs": 500, "validation_freq": 10, "verbose": 2,
                "callbacks": [
                    {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
        ...
        "data": {
            "dataset": {
                ...
                "methods": [
                    ...
                    {"map_list": {"method": "expand_distance_gaussian_basis", "distance": 5.0, "bins": 25,
                                  "expand_dims": False}},
                    {"set_attributes": {'range_indices':True}},
    ...
    "MoGAT": {
        ...
        "training": {
            "fit": {
                "batch_size": 64, "epochs": 300, "validation_freq": 1, "verbose": 2,
                "callbacks": []
            },
            "compile": {
    ...
    "INorp": {
        ...
        "training": {
            "fit": {
                "batch_size": 64, "epochs": 300, "validation_freq": 2, "verbose": 2,
                "callbacks": [
                    {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
    ...
    #             "depth": 5, "attention_args": {"units": 64},
    #             "dropout": 0.05,
    ...
    #     },
    #     "training": {
    #         "fit": {"batch_size": 64, "epochs": 200, "validation_freq": 1, "verbose": 2, "callbacks": []},
    #         "compile": {
    #             "optimizer": {"class_name": "Adam",
    #                 "config": {"lr": {
    #                     "class_name": "ExponentialDecay",
    ...
    "coGN": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 64, "epochs": 500, "validation_freq": 20, "verbose": 2,
                "callbacks": [
                    # {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
