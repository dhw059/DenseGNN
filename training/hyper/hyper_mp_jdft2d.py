hyper = {
    ...
    #                 # {'shape': (None, 2), 'name': "range_indices", 'dtype': 'int64', 'ragged': True},
    #                 # {'shape': (None, 3), 'name': "cell_translation", 'dtype': 'int64', 'ragged': True},
    #                 # {'shape': (3, 3), 'name': "graph_lattice", 'dtype': 'float32', 'ragged': False},
    ...
    #             "gauss_args": {"bins": 25, "distance": 6, "offset": 0.0, "sigma": 0.4}, "verbose": 10,
    ...
    #             "gin_mlp": {"units": [64], "use_bias": True, "activation": ["swish"],
    #                         },
    #             "output_mlp": {"use_bias": [True, True, True], "units": [64, 32, 1], "activation": ["swish", "swish", "linear"]}
