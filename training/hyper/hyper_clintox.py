hyper = {
    ...
    "AttentiveFP": {
        ...
        "training": {
            ...
            "compile": {
                "optimizer": {"class_name": "Adam",
                              "config": {"lr": 0.0031622776601683794
                                         }
                              },
                # "loss": "kgcnn>BinaryCrossentropyNoNaN",
                # "metrics": ["kgcnn>BinaryAccuracyNoNaN",
    ...
    "Schnet": {
        "model": {
            ...
            "config": {
                ...
                # "input_embedding": {"node": {"input_dim": 95, "output_dim": 64}},
                "input_embedding": {"node": {"input_dim": 95, "output_dim": 64}, "edge": {"input_dim": 8, "output_dim": 64}},
        ...
        "data": {
            "dataset": {
                ...
                "methods": [
                    {"set_attributes": {}},
                    {"map_list": {"method": "set_range", "max_distance":2, "max_neighbours": 5}}
                ]
            },
        },
        "info": {
