hyper = {
    ...
    "PAiNN": {
        ...
        "training": {
            "fit": {"batch_size": 32, "epochs": 300, "validation_freq": 20, "verbose": 2,
                    "callbacks": []
                    },
            "compile": {
                # "optimizer": {
    ...
    "DimeNetPP": {
        ...
        "training": {
            ...
            "scaler": {"class_name": "StandardScaler", "config": {"with_std": True, "with_mean": True, "copy": True}},
            "fit": {
                "batch_size": 32, "epochs": 300, "validation_freq": 20, "verbose": 2, "callbacks": []
            },
            "compile": {
                # "optimizer": {
                #     "class_name": "Addons>MovingAverage", "config": {
        ...
        "data": {
            "dataset": {
                ...
                "methods": [
                 ...
                 {"map_list": {"method": "set_range", "max_distance": 3, "max_neighbours": 40}}
