...
hyper = {  "DenseGNN": {
        "model": {
            ...
            "config": {
                ...
                "graph_mlp": {"units": [64], "use_bias": True, "activation": ["swish"],
                            },

                "gin_args": {"pooling_method":"sum", 
                             "edge_mlp_args": {"units": [64], "use_bias": True, "activation": ["swish"]}, 
                             "concat_args": {"axis": -1}, 
                             "node_mlp_args": {"units": [64], "use_bias": True, "activation": ["swish"]},
                             "graph_mlp_args": {"units": [64], "use_bias": True, "activation": ["swish"]},
                             },

            }
        },
        "training": {
            "fit": {"batch_size": 64, "epochs": 100, "validation_freq": 20, "verbose": 2, "callbacks": []},
            "compile": {
        ...
        "data": {
            "dataset": {
                "class_name": "JarvisDfptPiezoMaxDijDataset",
                "module_name": "kgcnn.data.datasets.JarvisDfptPiezoMaxDijDataset",
                "config": {},
                "methods": [
