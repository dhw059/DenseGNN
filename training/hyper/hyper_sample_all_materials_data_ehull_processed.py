hyper = {
    ...
    "Megnet.make_crystal_model": {
        ...
        "data": {
            "dataset": {
                "class_name": "SampleAllMPEhullDataset",
                "module_name": "kgcnn.data.datasets.SampleAllMPEhullDataset",
                "config": {},
                "methods": [
    ...
    "coGN": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 512, "epochs": 160, "validation_freq": 20, "verbose": 2,
                "callbacks": [
                    # {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
    ...
    "DenseGNN": {
        ...
        "training": {
            "fit": {"batch_size": 256, "epochs": 140, "validation_freq": 20, "verbose": 2, "callbacks": []},
