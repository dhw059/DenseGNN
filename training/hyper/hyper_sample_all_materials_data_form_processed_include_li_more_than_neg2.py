hyper = {
    ...
    "Megnet.make_crystal_model": {
        ...
        "data": {
            "dataset": {
                "class_name": "SampleAllMPFormIncludeLiMoreThanNEG2Dataset",
                "module_name": "kgcnn.data.datasets.SampleAllMPFormIncludeLiMoreThanNEG2Dataset",
                "config": {},
                "methods": [
    ...
    "Schnet.make_crystal_model": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 256, "epochs": 200, "validation_freq": 20, "verbose": 2,
                "callbacks": [
                    {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
