hyper = {
    "Megnet.make_crystal_model": {
        ...
        "training": {
            ...
            "fit": {
                "batch_size": 256, "epochs": 500, "validation_freq": 20, "verbose": 2,
                "callbacks": [
    ...
    "coGN": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 128, "epochs": 800, "validation_freq": 10, "verbose": 2,
                "callbacks": [
                    # {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
    ...
    "AttentiveFP": {
        ...
        "training": {
            "fit": {"batch_size": 128, "epochs": 300, "validation_freq": 10, "verbose": 2, "callbacks": []
                    },
            "compile": {
   ...
   "GIN": {
    ...
    #             # V1
    #             # "gin_mlp": {"units": [128, 128], "use_bias": True, "activation": ["relu", "relu"],
    #             #             "use_normalization": True, "normalization_technique": "graph_batch"},
    #             # # "gin_args": {},
    #             # "gin_args": {"pooling_method":"sum",
    #             #               "edge_mlp_args": {"units": [128,128], "use_bias": True, "activation": ["relu","relu"]}, 
    #             #              "concat_args": {"axis": -1}, 
    #             #              "node_mlp_args": {"units": [128, 128, 128], "use_bias": True, "activation": ["relu","relu","relu"]},},

    #             # V2
    #             # "gin_mlp": {"units": [128,128], "use_bias": True, "activation": ["relu","relu"],
    #             #             "use_normalization": True, "normalization_technique": "graph_batch"},
    #             # "gin_args": {"pooling_method":"sum", 
    #             #              "edge_mlp_args": {"units": [128], "use_bias": True, "activation": ["relu"]}, 
    #             #              "concat_args": {"axis": -1}, 
    #             #              "node_mlp_args": {"units": [128,128], "use_bias": True, "activation": ["relu","relu"]},},

                
    #             # V3
    #             "gin_mlp": {"units": [128], "use_bias": True, "activation": ["relu", "relu"],
    #                         },
    #             "graph_mlp": {"units": [128], "use_bias": True, "activation": ["relu", "relu"],
    #                         },
    #             "gin_args": {"pooling_method":"sum", 
    ...
    #             "last_mlp": {"use_bias": True, "units": [256], "activation": ["relu"]},
    #             "output_embedding": "graph",
    ...
    #             "methods": [
    #                 # {"set_attributes": {}}
    #                 {"map_list": {"method": "set_range_periodic", "max_distance": 5, "max_neighbours": None}},
    #                 {"map_list": {"method": "expand_distance_gaussian_basis", "distance": 5.0, "bins": 25,
    #                               "expand_dims": False}}
    #             ]
    #         },
        ...
        "data": {
            "dataset": {
                ...
                "methods": [
                    ...
                    {"map_list": {"method": "set_range_periodic", "max_distance": 4.0, "max_neighbours": 17}},
                    {"map_list": {"method": "expand_distance_gaussian_basis", "distance": 5.0, "bins": 25,
                                  "expand_dims": False}}
