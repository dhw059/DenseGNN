hyper = {
  ...
  "coGN": {
    ...
    "DenseGNN": {
            ...
            "config": {
                ...
                "input_block_cfg" : {'node_size': 128,
                   ...
                   'melting_point':True,    
                    ...
                    'average_anionic_radius':False,  
                    'velocity_sound':False,          
                    'thermal_conductivity':False,   
                    'electrical_resistivity':False, 
        ...
        "data": {
            "dataset": {
                "class_name": "JarvisMagmomOszicarDataset",
                "module_name": "kgcnn.data.datasets.JarvisMagmomOszicarDataset",
                "config": {},
                "methods": [
