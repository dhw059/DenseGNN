hyper = {
    ...
    "AttentiveFP": {
        ...
        "training": {
            "fit": {
                "batch_size": 200, "epochs": 300, "validation_freq": 1, "verbose": 2,
                "callbacks": []
            },
            "compile": {
    ...
    "GraphSAGE": {
        ...
        "training": {
            "fit": {"batch_size": 32, "epochs": 300, "validation_freq": 10, "verbose": 2,
    ...
    "DimeNetPP": {
        ...
        "training": {
            "fit": {
                "batch_size": 10, "epochs": 300, "validation_freq": 10, "verbose": 2, "callbacks": []
            },
            "compile": {
                # "optimizer": {
                #     # Addons>MovingAverage
...
,
   ...
   "DenseGNN": {
        ...
        "training": {
            ...
            "fit": {
                    "batch_size": 128, "epochs": 800, "validation_freq": 20, "verbose": 2,
                    "callbacks": [
                        {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
                            "learning_rate_start": 0.0005, "learning_rate_stop": 1e-05, "epo_min": 100, "epo": 800,
                            "verbose": 0
        ...
        "data": {
            "dataset": {
                ...
                "methods": [
                 ...
                 {"map_list": {"method": "set_range", "max_distance": 3, "max_neighbours": 1000}}
