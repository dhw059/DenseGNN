hyper = {
    "Megnet.make_crystal_model": {
        "model": {
            ...
            "config": {
                ...
                'nblocks': 5, 'has_ff': True, 'dropout': None, 
    ...
    "Schnet.make_crystal_model": {
        ...
        "training": {
            ...
            "fit": {
                ...
                "callbacks": [
                    {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
                        "learning_rate_start": 3e-04, "learning_rate_stop": 1e-05, "epo_min": 30, "epo": 300,
                        "verbose": 0}
                     }
                ]
            },
            ...
            "compile": {
                "optimizer": {"class_name": "Adam", "config": {"lr": 3e-04}},
                "loss": "mean_absolute_error"
            },
    ...
    "DimeNetPP.make_crystal_model": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 64, "epochs": 780, "validation_freq": 10, "verbose": 2, "callbacks": [],
    ...
    "AttentiveFP": {
        "model": {
            ...
            "config": {
                ...
                "input_embedding": {
                    # "node_attributes": {"input_dim": 95, "output_dim": 64},
                    "edge_attributes": {"input_dim": 5, "output_dim": 64},
                    },
                
                 "input_block_cfg" : {'node_size': 64,
                    'atomic_mass': True,   # 
                   'atomic_radius': False, 
                   'electronegativity': False, 
                   'ionization_energy': False, 
    ...
    #             "gin_args": {"units": 64, "use_bias": True, 
    #                                 },

    #             "depth": 3,  "attention_args": {"units": 64},
    #             "dropout": 0.05,
    ...
    #                                "units_edge": 64,
    #                                "rate": 0.5, "use_dropout": False},   "gru_kwargs": {"units": 64},
    #         }
    #     },
    #     "training": {
    #         "fit": {"batch_size": 64, "epochs": 100, "validation_freq": 1, "verbose": 2, "callbacks": []},
    #         "compile": {
    #             "optimizer": {"class_name": "Adam",
    #                 "config": {"lr": {
    #                     "class_name": "ExponentialDecay",
    ...
    "INorp": {
        ...
        "training": {
            "fit": {
                "batch_size": 128, "epochs": 500, "validation_freq": 10, "verbose": 2,
                "callbacks": [
                    {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
    ...
    #             # V4
    #             # "gin_mlp": {"units": [128,128], "use_bias": True, "activation": ["swish", "swish"],
    #             #             },
    #             # "graph_mlp": {"units": [128,128], "use_bias": True, "activation": ["swish", "swish"],
    #             #             },
    #             # "gin_args": {"pooling_method":"sum", 
    #             #              "edge_mlp_args": {"units": [128,128], "use_bias": True, "activation": ["swish","swish"]}, 
    #             #              "concat_args": {"axis": -1}, 
    #             #              "node_mlp_args": {"units": [128,128,128], "use_bias": True, "activation": ["swish","swish","swish"]},
    #             #              "graph_mlp_args": {"units": [128,128], "use_bias": True, "activation": ["swish", "swish"]},
    #             #              },

           
    #             "last_mlp": {"use_bias": True, "units": [128, 128, 128], "activation": ["swish", "swish","swish"]},
    #             "output_embedding": "graph",
        ...
        "model": {
            ...
            "config": {
                ...
                "inputs": {
                        ...
                        "atomic_number": {"shape": (None,), "name": "atomic_number", "dtype": "int32", "ragged": True},
                        "CrystalNNFinger": {"shape": (None,24), "name": "CrystalNNFinger", "dtype": "float32", "ragged": True},
                        # "AGNIFingerprints": {"shape": (None,24), "name": "AGNIFingerprints", "dtype": "float32", "ragged": True},
                        "edge_indices": {"shape": (None, 2), "name": "edge_indices", "dtype": "int64", "ragged": True},
                        "charge": {'shape': [1], 'name': "charge", 'dtype': 'float32', 'ragged': False},
...
#                 "gauss_args": {"bins": 25, "distance": 8.0, "offset": 0.0, "sigma": 0.4},
#                 "depth": 5, "n_units":128,
...
#                     {"map_list": {"method": "set_range_periodic", "max_distance": 4.0, "max_neighbours": 17}} , # "max_neighbours": 17
    ...
    "coGN": {
        ...
        "training": {
            "cross_validation": {"class_name": "KFold",
                                 "config": {"n_splits": 5, "random_state": 42, "shuffle": True}},
            "fit": {
                "batch_size": 128, "epochs": 500, "validation_freq": 20, "verbose": 2,
                "callbacks": [
                    # {"class_name": "kgcnn>LinearLearningRateScheduler", "config": {
