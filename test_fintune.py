...
# Usage:
config = GNNTrainConfig(hyper="training/hyper/hyper_include_li_mp_eform.py",
                         model='DenseGNN', 
                        make='make_model_asu', dataset='FilterIncludeLiMPeformDataset', seed=42)
...
# datapath = "/home/deep/gcnn_keras-master/results/FilterIncludeLiMPeformDataset/DenseGNN_make_model_asu/DenseGNN_data.pickle"
...
for current_fold, (train_index, test_index) in enumerate(train_test_indices):
    ...
    filepath_transfer = "/home/deep/gcnn_keras-master/results/SampleAllMPFormDataset/DenseGNN_make_model_asu-/model_fold_2.h5"

    #  Load the entire model's weights first
    model.load_weights(filepath_transfer)

    # Define prefixes of the layers whose weights you want to keep
    # prefixes_to_keep = [ 'dense_gnn' ,'mlp']

    # 'dense_gnn', 'dense_embedding','mlp'
    # crystal_input_block_14 ,sequential_graph_network_14 ,graph_network_multiplicity_readout_14
    # schnet: sch_net_interaction
    # megnet :mlp 
    # cgcnn: cgcnn_layer
