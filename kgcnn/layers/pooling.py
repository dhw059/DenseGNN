...
class PoolingEmbedding(GraphBaseLayer):
    ...
    def call(self, inputs, **kwargs):
        ...
        out = segment_ops_by_name(self.pooling_method, nod, batchi) # 在每个batch中按照pooling_me，得到graph representation
        return out
...
class PoolingWeightedEmbedding(GraphBaseLayer):
    r"""Pooling all embeddings of edges or nodes per batch to obtain a graph level embedding in form of a
    :obj:`tf.Tensor` .
