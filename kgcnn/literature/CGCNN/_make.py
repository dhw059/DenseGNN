...
model_crystal_default = {
    ...
    "output_embedding": "graph", "gin_mlp":  {},
...
def make_crystal_model(inputs: list = None,
    ...
    # Model
    # edge_distances = Dense(conv_layer_args["units"], activation='linear')(edge_distances)
    ...
    for i in range(depth):
        ...
        np, ep= CGCNNLayer(**conv_layer_args)([n, ed, edge_indices])
        # be choosed
    ...
    if representation == 'asu':
        ...
        out = PoolingNodes(**node_pooling_args)(n) # G level
