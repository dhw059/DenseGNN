...
from kgcnn.layers.geom import NodeDistanceEuclidean, NodePosition, ShiftPeriodicLattice
...
def make_model(inputs: list = None,
    ...
    edge_image = ks.layers.Input(**inputs[3]) # edges,3
    lattice = ks.layers.Input(**inputs[4])# graph
    ...
    if make_distance:
        ...
        edge_input = NodeDistanceEuclidean()([pos1, pos2])
