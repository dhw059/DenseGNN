...
class JarvisMbjBandgapDataset(JarvisBenchDataset2021):
    ...
    def __init__(self, reload=False, verbose: int = 10):
        r"""Initialize 'mbj_bandgap' dataset.

        Args:
            reload (bool): Whether to reload the data and make new dataset. Default is False.
            verbose (int): Print progress or info for processing where 60=silent. Default is 10.
        """
        super(JarvisMbjBandgapDataset, self).__init__("mbj_bandgap", reload=reload, verbose=verbose)
        self.label_names = "mbj_bandgap "
