...
class JarvisMagmomOszicarDataset(JarvisBenchDataset2021):
    ...
    def __init__(self, reload=False, verbose: int = 10):
        r"""Initialize 'magmom_oszicar' dataset.

        Args:
            reload (bool): Whether to reload the data and make new dataset. Default is False.
            verbose (int): Print progress or info for processing where 60=silent. Default is 10.
        """
        super(JarvisMagmomOszicarDataset, self).__init__("magmom_oszicar", reload=reload, verbose=verbose)
        self.label_names = "magmom_oszicar "
        self.label_units = "muB"
