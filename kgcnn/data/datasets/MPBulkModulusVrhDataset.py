...
class MPBulkModulusVrhDataset(MatBenchDataset2020):
    r"""Store and process :obj:`MPBulkModulusVrhDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    database.  
    ...
    def __init__(self, reload=False, verbose: int = 10):
        r"""Initialize 'bulk_modulus_vrh' dataset.
        ...
        super(MPBulkModulusVrhDataset, self).__init__("all_materials_kvrh_data_processed", reload=reload, verbose=verbose)
        self.label_names = "bulk_modulus_vrh"
