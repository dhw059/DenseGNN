...
class LiSSEEhullMPDataset(MatBenchDataset2020):
    r"""Store and process :obj:`LiSSEEhullMPDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    database.  
    ...
    def __init__(self, reload=False, verbose: int = 10):
        ...
        super(LiSSEEhullMPDataset, self).__init__("li_sse_ehull_mp_datasest", reload=reload, verbose=verbose)
