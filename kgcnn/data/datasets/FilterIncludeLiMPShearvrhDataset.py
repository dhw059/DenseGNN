...
class FilterIncludeLiMPShearvrhDataset(MatBenchDataset2020):
    r"""Store and process :obj:`FilterIncludeLiMPShearvrhDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    database.  
    ...
    def __init__(self, reload=False, verbose: int = 10):
        ...
        super(FilterIncludeLiMPShearvrhDataset, self).__init__("include_li_mp_gvrh", reload=reload, verbose=verbose)
