...
class JarvisPhHeatCapacityDataset(JarvisBenchDataset2021):
    ...
    def __init__(self, reload=False, verbose: int = 10):
        r"""Initialize 'ph_heat_capacity' dataset.

        Args:
            reload (bool): Whether to reload the data and make new dataset. Default is False.
            verbose (int): Print progress or info for processing where 60=silent. Default is 10.
        """
        super(JarvisPhHeatCapacityDataset, self).__init__("ph_heat_capacity", reload=reload, verbose=verbose)
        self.label_names = "ph_heat_capacity "
        self.label_units = "J/K/kg"
