...
class FilterIncludeLiMPBulkvrhDataset(MatBenchDataset2020):
    r"""Store and process :obj:`FilterIncludeLiMPBulkvrhDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    database.  
    ...
    def __init__(self, reload=False, verbose: int = 10):
        ...
        super(FilterIncludeLiMPBulkvrhDataset, self).__init__("include_li_mp_kvrh", reload=reload, verbose=verbose)
