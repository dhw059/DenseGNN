...
class LiSSEBulkVRHMPDataset(MatBenchDataset2020):
    r"""Store and process :obj:`LiSSEBulkVRHMPDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    database.  
    ...
    def __init__(self, reload=False, verbose: int = 10):
        ...
        super(LiSSEBulkVRHMPDataset, self).__init__("li_sse_bulk_modulus_mp_datasest", reload=reload, verbose=verbose)
