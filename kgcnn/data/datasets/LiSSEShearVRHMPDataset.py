...
class LiSSEShearVRHMPDataset(MatBenchDataset2020):
    r"""Store and process :obj:`LiSSEShearVRHMPDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    database.  
    ...
    def __init__(self, reload=False, verbose: int = 10):
        ...
        super(LiSSEShearVRHMPDataset, self).__init__("li_sse_shear_modulus_mp_datasest", reload=reload, verbose=verbose)
