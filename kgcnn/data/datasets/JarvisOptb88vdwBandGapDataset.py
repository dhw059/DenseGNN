...
class JarvisOptb88vdwBandGapDataset(JarvisBenchDataset2021):
    ...
    def __init__(self, reload=False, verbose: int = 10):
        r"""Initialize 'optb88vdw_bandgap' dataset.

        Args:
            reload (bool): Whether to reload the data and make new dataset. Default is False.
            verbose (int): Print progress or info for processing where 60=silent. Default is 10.
        """
        super(JarvisOptb88vdwBandGapDataset, self).__init__("optb88vdw_bandgap", reload=reload, verbose=verbose)
        self.label_names = "optb88vdw_bandgap "
