...
class FilterIncludeLiMPEhullDataset(MatBenchDataset2020):
    r"""Store and process :obj:`FilterIncludeLiMPEhullDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    database.  
    ...
    def __init__(self, reload=False, verbose: int = 10):
        r"""Initialize 'e above hull' dataset.
        ...
        super(FilterIncludeLiMPEhullDataset, self).__init__("include_li_mp_ehull", reload=reload, verbose=verbose)
