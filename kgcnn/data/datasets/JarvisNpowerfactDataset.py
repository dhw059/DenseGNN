...
class JarvisNpowerfactDataset(JarvisBenchDataset2021):
    ...
    def __init__(self, reload=False, verbose: int = 10):
        r"""Initialize 'n_powerfact' dataset.

        Args:
            reload (bool): Whether to reload the data and make new dataset. Default is False.
            verbose (int): Print progress or info for processing where 60=silent. Default is 10.
        """
        super(JarvisNpowerfactDataset, self).__init__("n_powerfact", reload=reload, verbose=verbose)
        self.label_names = "n_powerfact "
