...
class EXPOrderGapDataset(MatBenchDataset2020):
    r"""Store and process :obj:`EXPOrderGapDataset` from `MatBench <https://matbench.materialsproject.org/>`__
    ...
    def __init__(self, reload=False, verbose: int = 10):
        ...
        super(EXPOrderGapDataset, self).__init__("band_gap_order_exp", reload=reload, verbose=verbose)
